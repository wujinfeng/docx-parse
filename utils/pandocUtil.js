...
let strategies = {
    '1.19': function (templateFile, inputFile, outFile) {
        return pandocV119TransDocx(templateFile, inputFile, outFile);
    },
    '2.5': function (templateFile, inputFile, outFile) {
        return pandocV25TransDocx(templateFile, inputFile, outFile);
    }
};
